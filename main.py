...
MA12, MA26, EMA12, EMA26 = \
    '12-tick Moving Avg', '26-tick Moving Avg', '12-tick EMA', '26-tick EMA'
...
def _ema(prices, days=10):
    ...
    # The 0.8647 normalizes out that we stop the EMA after a finite number of
    # terms
